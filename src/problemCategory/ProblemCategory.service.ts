...
export class ProblemCategoryService {
  ...
  getById = async (id: ID): Promise<ProblemCategory> => {
  ...
  create = async (collection: CreateProblemCategoryDto): Promise<ProblemCategory> => {
    return await this.model.create(collection);
  };

  update = async (
    id: ID,
    collection: UpdateProblemCategoryDto,
  ): Promise<ProblemCategory> => {
    return await this.model.findByIdAndUpdate(id, collection, { new: true });
  };

  async remove(id: ID): Promise<ProblemCategory> {
